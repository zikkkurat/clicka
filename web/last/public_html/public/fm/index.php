...
<head>
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            .text-white { color: #0085FF!important }
            .navbar-dark .navbar-brand { color: #0085FF!important }
            body.theme-dark { background-color: #2f2a2a; }
            .list-group .list-group-item { background: #343a40; }
            .theme-dark .navbar-nav i, .navbar-nav .dropdown-toggle, .break-word { color: #0085FF; }
            a, a:hover, a:visited, a:active, #main-table .filename a { color: #0085FF ; }
            ul#search-wrapper li:nth-child(odd) { background: #f9f9f9cc; }
            .theme-dark .btn-outline-primary { color: #0085FF ; border-color: #0085FF ; }
            .theme-dark .btn-outline-primary:hover, .theme-dark .btn-outline-primary:active { background-color: #15395a;}
            a.dropdown-item.nav-link { background-color: #15395a; }
        </style>
    <?php endif; ?>
</head>
...
<script>
    ...
    $(document).ready( function () {
        ...
        var $table = $('#main-table'),
            ...
            mainTable = $('#main-table').DataTable({language:{url:'//cdn.datatables.net/plug-ins/1.10.24/i18n/Russian.json'},"paging": false, "info": false, "order": [], "columnDefs": [{"targets": _targets, "orderable": false}]
        });
        //search
